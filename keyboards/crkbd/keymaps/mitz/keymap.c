...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_NAV] = LAYOUT(
      KC_BSPC, KC_DEL, C(KC_LEFT), KC_UP, C(KC_RIGHT), _______,     KC_PLUS, KC_7, KC_8, KC_9, KC_MINUS, _______,
      LCTL_T(KC_TAB), KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,   KC_EQUAL, KC_4, KC_5, KC_6, KC_0, _______,
      KC_STAB, _______, _______, _______, _______, _______,     KC_SLASH, KC_1, KC_2, KC_3, KC_DOT, _______,
      _______, _______, _______,
