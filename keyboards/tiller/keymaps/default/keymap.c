...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_BASE] = LAYOUT(
      ...
      MO(LAYER_NAV), KC_A, KC_S, KC_D, KC_F, KC_G, XXXXXXX,
      MO(LAYER_SYM), KC_Z, KC_X, KC_C, KC_V, KC_B, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LALT, LM(LAYER_SFT, MOD_LSFT), KC_LCTL,
    ...
    [LAYER_NAV] = LAYOUT(
      ...
      _______, KC_ENT, _______, S(KC_TAB), KC_TAB, _______, _______,
      _______, _______, _______, _______, LM(LAYER_TAB, MOD_RALT), _______, LM(LAYER_TAB, MOD_RCTL),
    ...
    [LAYER_TAB] = LAYOUT(
      _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______, S(KC_TAB), KC_TAB, _______, _______,
      _______, _______, _______, _______, _______, _______, _______,
