...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_BASE] = LAYOUT(
      ...
      CTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, XXXXXXX,
      SFT_T(KC_DEL), KC_Z, KC_X, KC_C, KC_V, KC_B, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, GUI_T(KC_DEL), SFT_T(KC_BSPC), CTL_T(KC_TAB),
