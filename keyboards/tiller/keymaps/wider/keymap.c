...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_BASE] = LAYOUT(
      ...
      TD(TD_SFT_CTL), KC_Z, KC_X, KC_C, KC_V, KC_B, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TD(TD_ALT_GUI), SFT_T(KC_BSPC), CTL_T(KC_TAB),
      ...
      LT(LAYER_NAV, KC_ENT), LT(LAYER_SYM, KC_SPC), KC_ESC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [LAYER_NAV] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,  CTL_T(KC_DEL),
